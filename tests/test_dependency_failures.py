...
class TestDependencyFailures:
    ...
    @patch("pywinauto_mcp.tools.portmanteau_face.FACE_RECOGNITION_AVAILABLE", False)
    def test_face_tool_missing_dependency(self, verify_result):
        ...
        from pywinauto_mcp.tools.portmanteau_face import automation_face
        from pywinauto_mcp.tools.models import FaceOperationRequest
    ...
    @patch("pywinauto_mcp.app.OCR_AVAILABLE", False)
    def test_visual_tool_missing_ocr(self, verify_result):
        ...
        from pywinauto_mcp.tools.models import VisualOperationRequest
