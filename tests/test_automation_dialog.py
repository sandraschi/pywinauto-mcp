...
from pywinauto_mcp import dialog_engine
from pywinauto_mcp.tools.models import DialogOperationRequest, ToolResult
from pywinauto_mcp.tools.portmanteau_dialog import automation_dialog


class TestDialogEngine:
    @patch("pywinauto_mcp.dialog_engine.pyautogui")
    @patch("pywinauto_mcp.dialog_engine.pyperclip")
...
class TestAutomationDialogTool:
    @patch("pywinauto_mcp.tools.portmanteau_dialog.dialog_engine.submit_path")
