...
import { List, ChevronRight, MousePointer2 } from "lucide-react";

export function Elements() {
    return (
        <div className="space-y-6">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-bold tracking-tight text-white">Element Inspector</h1>
                <p className="text-slate-400 italic">Hierarchical decomposition of the Windows UI automation tree.</p>
            </div>
            ...
            <Card className="border-slate-800 bg-slate-950/50">
                ...
                <CardContent className="space-y-1">
                    ...
                    <div className="flex items-center gap-2 p-2 hover:bg-slate-800/50 rounded-md cursor-pointer ml-4 text-slate-300">
                        ...
                        <span className="font-mono text-sm text-blue-400">[Window] web_sota - Visual Studio Code</span>
                    </div>
