    ...
    return (
        <div className="space-y-3">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-slate-400">
                ...
                <Button type="button" variant="outline" size="sm" className="h-7 border-slate-700" onClick={reset}>
                    <RotateCcw className="h-3.5 w-3.5 mr-1" />
                    Reset view
                </Button>
            </div>
            <p className="text-[11px] text-slate-500 leading-relaxed">
                2D preview in your browser — pan (drag), zoom (wheel), rotate (slider). This is not a 3D scene graph
                of the Windows desktop; use MCP tools + screenshots for real UI work. Physical robots live in your
                fleet <span className="text-slate-400">robotics-mcp</span>, not here.
            </p>
        </div>
    );
}
