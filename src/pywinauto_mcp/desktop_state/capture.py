...
class DesktopStateCapture:
    ...
    def capture(
        ...
        *,
        ...
        screenshot = None
        if mode == "som":
            from pywinauto_mcp.dispatch import should_avoid_foreground_reads
            from pywinauto_mcp.win32_window import get_window_bbox, grab_window_image
    ...
    def _grab_scope(self, window_handle: int | None):
        ...
        from pywinauto_mcp.dispatch import should_avoid_foreground_reads
        from pywinauto_mcp.win32_window import grab_window_image
