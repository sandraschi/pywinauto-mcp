...
ENV_DISPATCH = "PYWINAUTO_MCP_DISPATCH"
    ...
    *,
    ...
    if dispatch == "background":
        ...
        if window_handle is not None:
            try:
                from pywinauto_mcp.agent_overlay import show_agent_cursor
                from pywinauto_mcp.win32_window import postmessage_click_at
