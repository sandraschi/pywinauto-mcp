...
- **Safety:** Mutating mouse/keyboard may require **`approve_automation`**. See **`docs/SAFETY.md`** and env vars like **`PYWINAUTO_MCP_KILL_SWITCH`**, **`PYWINAUTO_MCP_DRY_RUN`**.
...
- **`automation_face`** — optional face features; **off** unless **`PYWINAUTO_MCP_ENABLE_FACE=1`** + face extra (**`docs/SAFETY.md` §5**).
