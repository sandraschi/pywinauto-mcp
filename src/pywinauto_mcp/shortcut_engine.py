...
from pywinauto_mcp.app_shortcuts.registry import get_shortcut, list_shortcuts
from pywinauto_mcp.keyboard_send import is_modifier_combo, parse_hotkey, send_hotkey, send_press
