...
from pywinauto_mcp.cua_env import cua_getenv
...
def retry_attempts() -> int:
    raw = cua_getenv("CUA_MCP_RETRY_ATTEMPTS", "PYWINAUTO_MCP_RETRY_ATTEMPTS", "RETRY_ATTEMPTS", default="3")
    return max(1, int(raw or "3"))


def retry_delay() -> float:
    raw = cua_getenv("CUA_MCP_RETRY_DELAY", "PYWINAUTO_MCP_RETRY_DELAY", "RETRY_DELAY", default="1.0")
