...
if app is not None and DesktopStateCapture is not None:
    ...
    def get_desktop_state(
        ...
        Example:
            ...
            Full analysis: get_desktop_state(use_vision=True, use_ocr=True, max_depth=15)
        """
        try:
            logger.info(f"Starting desktop state capture (vision={use_vision}, ocr={use_ocr}, depth={max_depth})")
