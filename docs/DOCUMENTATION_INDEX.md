...
**Start here:** [docs/README.md](README.md) — curated hub for **pywinauto-mcp**.
...
These paths were copied from other fleet repos or are historical — **do not treat as pywinauto-mcp source of truth:**
